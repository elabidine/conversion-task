...
def convert_currency(price:Decimal, from_currency: Currency, to_currency: Currency = None, date=None) -> Decimal:
    ...
    - Raises:
            - ValueError: If the currencies are the same, or if either currency is None.
            - ValueError: If either provided currency is invalid.
    """
...
def get_exchange_rate(currency: Currency) -> Decimal:
    ...
    try:
        ...
        pass  # No stored rate, fetch it from the API
...
def fetch_specific_rate_from_api(currency: Currency) -> Decimal:
    ...
    BASE_CURRENCY = "EUR"
    API_KEY = "20c8e151c59845135f57aa5fe4543e40"
